...
# {'id':4209,'moduleId':'test3','type':'AI','source_index_list':[0], 
...
#           LIST - list[int]
# source_index_list->list: позиции (индексы с 0) данных массива результата чтения модуля moduleId
...
channels_config={
    'channels': [
        ...
        {'id': 2000,            # DEMO machine for idles
         'handler': handlers.r_level_timeout,
         'args': {
             'channel_id': 2000,
    ...
    'nodes': [  
        {'id': 2121,        # AI
         'moduleId': 'cocos_ai', 'source_index_list': [0],
        ...
        {'id': 2120,
         'moduleId': 'cocos_di', 'source_index_list': [0, 1],
    ...
    'programms':[
        ...
        {'id': 17000, 'handler': handlers.idle,
                'args': {
