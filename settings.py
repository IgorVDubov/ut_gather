...
ALLOWED_MACHINES={2020:['192.168.1.200', '127.0.0.1', '192.168.1.244', '192.168.1.125']} # id каналов и разрешенные ip, к которым могут подключаться клиенты контроля простоя через запрос ?m=id
